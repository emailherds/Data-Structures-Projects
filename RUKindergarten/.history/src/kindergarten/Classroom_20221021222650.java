...
public class Classroom {
    ...
    public void deleteLeavingStudent (String firstName, String lastName) {
        ...
        if(studentsInLine != null){
            ...
            while(!hit){
                String f = studentsInLine.getStudent().getFirstName();
                String l = studentsInLine.getStudent().getLastName();

                if(f.equals(firstName) && l.equals(lastName)&& counter == 0){
                    studentsInLine = studentsInLine.ne
                }
            }
