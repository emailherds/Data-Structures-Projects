            ...
            if(random == size-1){
                for(int i = 0; i < size+1; i++){
                    if(i == size){
                        ...
                        temp = musicalChairs.getNext(); // set the new last node of the musical chairs to the one right before
                    }else
                        musicalChairs = musicalChairs.getNext();
                }
            }else if(random == 0){
                ...
                for(int i = 0; i<random; i++){
                    if(i == random+1){
                        String b = musicalChairs.getStudent().getFullName();
                        //SNode temp2 = new SNode(musicalChairs.getNext().getStudent(),null); 
                        a = musicalChairs.getNext().getStudent().getFullName();
                        //sortByHeight(temp2);
