...
public class Classroom {
    ...
    public void makeClassroom ( String filename ) {
        ...
        for(int i = 0; i < size-1; i++){
            ...
            while(std.getStudent().compareNameTo(studentsInLine.getStudent()) < 0){ // runs while current node is less than the node in the list
                //first case: less than first node
                if(std.getStudent().compareNameTo(first.getStudent()))
            }
