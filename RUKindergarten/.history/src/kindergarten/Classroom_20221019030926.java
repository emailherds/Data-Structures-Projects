    ...
    public void makeClassroom ( String filename ) {
        ...
        for(int i = 0; i < size-1; i++){
            ...
            while(!sorted){ // runs while current node is less than the node in the list
                ...
                std.getStudent().getLastName();
                studentsInLine.getStudent().getLastName();
                ...
                else if(studentsInLine.getNext() == null&&std.getStudent){
                    studentsInLine.setNext(std);
                    sorted = true;
                }else if(std.getStudent().compareNameTo(studentsInLine.getStudent())>0){
